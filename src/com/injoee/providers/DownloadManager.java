...
import com.injoee.providers.downloads.Downloads;
...
public class DownloadManager {
	...
	private static final String[] COLUMNS = new String[] { COLUMN_ID,
			...
			COLUMN_LAST_MODIFIED_TIMESTAMP, COLUMN_ITEM_ID};
	...
	private static final String[] UNDERLYING_COLUMNS = new String[] {
			...
			Downloads.COLUMN_FILE_NAME_HINT, Downloads._DATA, Downloads.COLUMN_REFERER};
	...
	public static class Request {
		 ...
		 * {@link com.injoee.providers.NotificationManager}. By default, a
		 ...
		 * added by Joe Xie
		 */
		public Request setItemId(String itemId) {
			mItemId = itemId;
			return this;
		}
		...
		ContentValues toContentValues(String packageName) {
			...
			//Added by Joe Xie
			putIfNonNull(values, Downloads.COLUMN_REFERER, mItemId);
	...
	public static class Query {
		...
		/**
		 * Include only downloads with URI matching the given url
		 * 
		 * 
		 * @param downloadUrl
		 *            
		 * @return this object
		 */
		public Query setFilterByUrl(String mDownloadUrl) {
			mUrl = mDownloadUrl;
			return this;
		}
		 ...
		 * @return this object
		 */
		public Query setFilterByItemId(String itemId) {
			mItemId = itemId;
			return this;
		}
		...
		Cursor runQuery(ContentResolver resolver, String[] projection,
			...
			if (mUrl != null) {
				selectionParts.add(urlClause("=", mUrl));
			}
			
			if (mItemId != null) {
				selectionParts.add(Downloads.COLUMN_REFERER + "='" + mItemId + "'");
			}
		...
		private String urlClause(String operator, String value) {
			return Downloads.COLUMN_URI + operator +"'" + value +"'";
		}
	...
	private static class CursorTranslator extends CursorWrapper {
		...
		private String translateString(String column) {
			...
			if (column.equals(COLUMN_ITEM_ID)) {
				return getUnderlyingString(Downloads.COLUMN_REFERER);
			}
